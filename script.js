...
document.getElementById("priority-btn").onclick = () => {
    let currentPriorityPreference = document.getElementById("priority-preference").innerText;
    if (currentPriorityPreference == "high") {
        document.getElementById("priority-pref").innerText = "low";
    } else {
        document.getElementById("prior-pref").innerText = "high";
    }
...
function addProcess() {
    process++;
    let rowHTML1 = `
                          <td class="p-id" rowspan="2">P${process}</td>
                          <td class="priority hide" rowspan="2"><input id="dj" type="number" min="1" step="1" value="1"></td>
                          <td class="arrival-time" rowspan="2"><input id="dj" type="number" min="0" step="1" value="0"> </td>
                      ...
                      `;
    let rowHTML2 = `
                           <td class="process-time cpu process-input"><input id="j" type="number" min="1" step="1" value="1"> </td>
                      `;
